...
import NewRelease from '../src/components/NewReleaseComponent/NewReleaseComponent';
...
function App() {
  const [maincard, setMaincard] = useState(FilmData[0]); // Movie shown in Header by default

  return (
    <div className="App">
      <Navbar />

      {/* Pass selected movie (maincard) to Header */}
      <Header maincard={maincard} />

      {/* Pass FilmData and setMaincard to NewRelease */}
      <NewRelease movies={FilmData} setMaincard={setMaincard} />
    </div>
  );
}
